        ...
        chai
          ...
          .end(function (err, res) {
            ...
            assert.deepEqual(res.body[0], {
              ...
              issue_title: 'get',
              issue_text: 'issue',
              created_on: '2023-06-17T05:56:30.249Z',
              updated_on: '2023-06-17T05:56:30.249Z',
              created_by: 'asdf',
              assigned_to: '',
              open: true,
              status_text: '',
    ...
    suite('5 Put request Tests', function () {
      test('Update one field on an issue: PUT request to /api/issues/test-data-put', function (done) {
        chai
          ...
          .send({
            _id: '648d4d7256b4e42ba471a599',
            issue_title: 'different',
          })
          .end(function (err, res) {
            assert.equal(res.status, 200);
            assert.equal(res.body.result, 'successfully updated');
            assert.equal(res.body._id, '648d4d7256b4e42ba471a599');
